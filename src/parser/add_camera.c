...
/*   Updated: 2023/01/24 18:11:21 by gwinnink         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_camera	new_camera(t_vect3 pos, t_vect3 orient, int fov)
{
	...
	camera.fov = fov;
	camera.right = vect3_normalize(vect3_0(), (t_vect3){orient[2], 0, -1 * orient[0]});
	camera.up = vect3_normalize(vect3_0(), vect3_cross_product(orient, camera.right));
