...
/*   Updated: 2023/01/19 16:53:49 by fpurdom       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	test_scene(t_scene *scene)
{
	...
	obj_add_front(&scene->objs, obj_sp(obj_new(vect3(0, 0, 2), get_rgba(0, 255, 0, 255)), 1));
	...
	scene->light = new_light(vect3(0, 0, 0), 0.8, 0xFFFFFFFF);
	scene->amlight = new_amblight(0.3, 0xFFFFFFFF);
}
