...
/*   Updated: 2023/01/11 16:04:33 by fpurdom       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	test_scene(t_scene *scene)
{
	...
	obj_add_front(&scene->objs, obj_sp(obj_new(vect3(499, 510, 19), get_rgba(0, 0, 255, 255)), 3));
	...
	scene->light = new_light(vect3(1000, 1000, 1000), 0.8, 0xFFFFFFFF);
