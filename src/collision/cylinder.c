...
/*   Updated: 2023/01/24 16:13:19 by gwinnink         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
b = 2 * (dot_product(ray, x) - dot_product(ray, cylinder_dir) * dot_product(x, cylinder_dir)
...
{
	const t_vect3		x = cam_pos - cylinder.coords;
